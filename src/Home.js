    ...
    render() {
        return ( 
            <div className="main">
                ...
                <div classname="centered"><p classname="text">Ko-Fi Page<br/>(Click Badge Below)<br/><br/><a className="none" href="https://ko-fi.com/njaltheknut18327" target="_blank"  rel="noopener noreferrer">
                <img classname="linkImg" src="https://storage.ko-fi.com/cdn/brandasset/kofi_bg_tag_white.png?" alt="Ko-Fi Badge"/></a></p></div>
                </section>
                <br/>
                <hr className="blue"/>
                <br/>
